...
### 03b_output_ADNI_part_A_results.RData
 
Serialized RData file containing:
- WGCNA network objects
- Module assignments
- Module preservation statistics
- Intermediate objects for downstream analyses
...
6. Module scoring & feature selection  
7. Machine learning modeling  
8. Pathway enrichment (GSEA & ORA)  
